...
// let abc = new Str(str1);
// console.log(abc.str1Length())
...
// let familiya = "-----o"
// setInterval(() => {
//    ism = ism[ism.length - 1] + ism.substring(0, ism.length - 1)
//    familiya = familiya.substring(1) +  familiya[0]
//    console.log(familiya + ism)
// }, 50);
